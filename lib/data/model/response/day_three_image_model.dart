...
DayThreeImageModel DayThreeImageModelFromJson(String str) => DayThreeImageModel.fromJson(json.decode(str));

String DayThreeImageModelToJson(DayThreeImageModel data) => json.encode(data.toJson());

class DayThreeImageModel {
    ...
    factory DayThreeImageModel.fromJson(Map<String, dynamic> json) => DayThreeImageModel(
...
class ImageThree {
    ...
    factory ImageThree.fromJson(Map<String, dynamic> json) => ImageThree(
        ...
        users: List<User>.from(json["users"].map((x) => User.fromJson(x))).reversed.toList(),
